...
export default function Icon() {
  return (
    <div className="flex justify-center">
      {items.map((item) => {
        return (
          <Link to={'/graph'} className="dark:bg-icon-dark-bg bg-icon-bg h-64 w-64 bg-no-repeat bg-cover mx-10 rounded-3xl flex flex-col items-center hover:scale-110 cursor-pointer">
